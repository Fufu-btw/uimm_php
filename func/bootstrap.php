 ...
 */
function inputGeneral($type,$label,$nom,$placeholder="",$class="",$required=false,) {
    $str = '<div class="mb-3">';
 ...
 * @return string Code HTML
 */
function inputText($label,$nom,$placeholder="",$class="",$required=false) {
  return inputGeneral("text",$label,$nom,$placeholder,$class,$required);
}
 ...
 * @return string Code HTML
 */
function inputDate($label,$nom,$placeholder="",$class="",$required=false) {
  return inputGeneral("date",$label,$nom,$placeholder,$class,$required);
}
 ...
 * @return string Code HTML
 */
function inputColor($label,$nom,$placeholder="",$class="",$required=false) {
  return inputGeneral("color",$label,$nom,$placeholder,$class,$required);
}
 ...
 * @return string Code HTML
 */
function inputFile($label,$nom,$placeholder="",$class="",$required=false) {
  return inputGeneral("file",$label,$nom,$placeholder,$class,$required);
}
 ...
 * @return string Code HTML
 */
function inputNumber($label,$nom,$placeholder="",$class="",$required=false) {
  return inputGeneral("number",$label,$nom,$placeholder,$class,$required);
}
 ...
 * @return string Code HTML
 */
function inputEmail($label,$nom,$placeholder="",$class="",$required=false) {
  return inputGeneral("email",$label,$nom,$placeholder,$class,$required);
}
 ...
 * @return string Code HTML
 */
function inputPassword($label,$nom,$placeholder="",$class="",$required=false) {
    // Pas de reprise du mot de passe
    if (isset($_POST[$nom])) {
      $_POST[$nom]="";
    }
    return inputGeneral("password",$label,$nom,$placeholder,$class,$required);
}
 ...
 */
function buttonSubmit($name,$value,$class="") {
 ...
 * @return string Code HTML résultat
 */
function buttonLink($name,$url,$class="") {
